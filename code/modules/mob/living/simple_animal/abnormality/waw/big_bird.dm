...
/mob/living/simple_animal/hostile/abnormality/big_bird
	...
	middle_work_line = list("Behind %PERSON, the rumbling sound of a hairy black bird can be heard.}, {The sporadic squeals of a bird can be heard.}, {%ABNO cries behind %PERSON, acting as if it feels anxious.}, {%ABNO circles and roams around %PERSON, crying.")
